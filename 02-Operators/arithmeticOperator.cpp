...
// Write a program that calculates the price of tea packs. A user enters the number of tea packs they want, and the 
///price per pack. Apply a 10% tax to the total price and display the final cost.
